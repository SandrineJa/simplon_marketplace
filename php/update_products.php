...
<body>
    ...
    //if the POST variable isn't empty (when you submitted a form)
        ...
        $update_query = "UPDATE products SET product_name = '".$_POST['product_update']."' WHERE product_name = '".$_POST['product']."'"; 

        //displays a confirmation message if the query is executed
        if ($mysqli->query($update_query)) { ?>
            <p>La catégorie "<?php echo $_POST['product_update'] ?>" a bien été modifée, cliquez sur "retour" pour voir la nouvelle liste de catégories.</p>
        <?php
        }
